...
cc_tumor_fpkm <- read.csv("Data/GSE81861_CRC_tumor_all_cells_FPKM.csv")
...
ggsave(
  filename = "single_cell_library_histogram_pre_process_step_1.png",
...
ggsave(
  filename = "single_cell_library_histogram_pre_process_step_2.png",
  device = "png", units = "mm", dpi = 600, width = 20, height = 20,
...
saveRDS(cc_tumor_fpkm$denoised_sc_dataframe,
  file = "Data/denoised-colon-and-rectal-single-cell-data.rds"
)

head(as.data.frame(cc_tumor_fpkm$denoised_sc_dataframe))

saveRDS(cc_tumor_fpkm$cds_gene_names,
  file = "Data/denoised-colon-and-rectal-single-cell-data-gene-names.rds"
)
...
cds_output <- cell_dataset_builder(
  ...
  use.function = FALSE,
  norm.flag = "log",
  my.cds.filename = "Data/cds_ouput.rds",
  my.monocle.graph = "Data/vim_pseudotime.svg",
  my.monocle.graph.genes = "Data/vim_genes.svg",
  my.pt.data.filename = "Data/vim_pseudotime_data.csv"
)
...
saveRDS(mad.genes,
  file = "Data/mad_colon_and_rectal_cancer.rds"
)
...
```{r saving sde metric}
saveRDS(sde.genes,
  file = "Data/sde_colon_and_rectal_cancer.rds"
)
```
...
cox_df <- readRDS("Data/coad_df_finished.rds")
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/mad_coad_coefs_", gs, "_genes.csv")
  )
...
write.csv(mad_cindices_coad_df,
  file = "Data/mad_cindices_coad_across_gene_size.csv"
)
```
...
mad_coad <- read.csv("Data/mad_cindices_coad_across_gene_size.csv")
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/sde_coad_coefs_", gs, "_genes.csv")
  )
...
write.csv(sde_cindices_coad_df,
  file = "Data/sde_cindices_coad_across_gene_size.csv"
)
```
...
sde_coad <- read.csv("Data/sde_cindices_coad_across_gene_size.csv")
...
coad_mirnas <- mirna_calculator(
  ...
  mirna.ranking.name = "Data/high_mirna.rds",
  mirna.remove = c("hsa-miR-129-2-3p", "hsa-miR-129-1-3p"),
  mirna.genes.mat.name = "Data/mirna_high_matrix.rds",
  save.mirna.genes.mat = TRUE
)
```
```{r getting overlap of mirnas of tcga-coad and our mirnas}
mirna_high_matrix <- readRDS("Data/mirna_high_matrix.rds")
...
load("Data/mirna_heatmap_inputs/COAD/800_1010_targets.RData",
  verbose = TRUE
)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/high_mirna_coad_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_high_cindices_coad_across_gene_size.csv"
)
```
...
load("Data/mirna_heatmap_inputs/COAD/400_510_targets.RData", verbose = TRUE)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/medium_mirna_coad_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_medium_cindices_coad_across_gene_size.csv"
)
```
...
load("Data/mirna_heatmap_inputs/COAD/100_10_targets.RData", verbose = TRUE)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/low_mirna_coad_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_low_cindices_coad_across_gene_size.csv"
)
```
...
ggsave(
  filename = "Data/mirna_mirna_target_num_across_gene_size.svg",
...
mirna_high_df <- read.csv("Data/mirna_high_cindices_coad_across_gene_size.csv")
...
mad.genes <- readRDS("Data/mad_colon_and_rectal_cancer.rds")
sde.genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
cox_df <- readRDS("Data/coad_df_finished.rds")
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used) {
    ...
    mad_sde_optimized <- two_weight_optimizer(
      ...
      my.filename = paste0("Data/Optimizations/Optimization_", c, "_targets_mad_sde_", data_set, ".rds")
    )
    ...
    for (md in mad_sde_optimized) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.n = FALSE,
          tumor.m = FALSE,
          my.filename = paste0("Data/mad_sde_coad_coefs.csv")
        )
    ...
    write.csv(my_cindices, file = paste0("Data/top_cindices_mad_sde_coad_df.csv"))
  }
}
```
...
random_coad1 <- read.csv("Data/random_coad_genes1.csv")
random_coad2 <- read.csv("Data/random_coad_genes2.csv")
random_coad3 <- read.csv("Data/random_coad_genes3.csv")
random_coad4 <- read.csv("Data/random_coad_genes4.csv")
random_coad5 <- read.csv("Data/random_coad_genes5.csv")
random_coad6 <- read.csv("Data/random_coad_genes6.csv")
random_coad7 <- read.csv("Data/random_coad_genes7.csv")
random_coad8 <- read.csv("Data/random_coad_genes8.csv")
random_coad9 <- read.csv("Data/random_coad_genes9.csv")
random_coad10 <- read.csv("Data/random_coad_genes10.csv")
...
for (rg in all_random_gene_cindices) {
  ...
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = "Data/random_coad_coefs_for_random_genes.csv"
  )
...
write.csv(all_random_gene_cindices,
  file = "Data/coad_random_genes.csv"
)
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[21]) {
    my_cindices <- rep(0, 11)
    counter <- 1
    load(file = paste0("Data/mirna_heatmap_inputs/COAD/", c, "_targets.RData"), verbose = TRUE)
    mirna.genes <- mirna.ranking
    mirna_sde_optimized <- two_weight_optimizer(
      first.metric = mirna.genes,
      second.metric = sde.genes,
      my.filename = paste0("Data/Optimization_", c, "_targets_cc_singlecell_ms_", a, "_alpha_", data_set, ".rds")
    )
    ...
    for (ms in mirna_sde_optimized[10]) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.n = FALSE,
          tumor.m = FALSE,
          my.filename = paste0("Data/cc_singlecell_ms_ideal_gene_size_coefs.csv")
        )
    ...
    write.csv(top_cindices, file = paste0("Data/cc_singlecell_ms_coad_df_ideal_gene_size.csv"))
    write.csv(my_cindices, file = paste0("Data/cc_singlecell_ms_coad_df_all_gene_size_data.csv"))
  }
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used) {
    ...
    for (ms in mirna_sde_optimized) {
      cox_model <- cox_model_fitter(
        ...
        tumor.n = FALSE,
        tumor.m = FALSE,
        my.filename = paste0("Data/cc_singlecell_ms_ideal_mirna_combo_coefs.csv")
      )
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_ms_coad_df_ideal_mirna_combo.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_ms_coad_df_all_mirna_combo_performance_data.csv"))
}
```
...
gene_sizes <- seq(100, 3000, 50)
mad.genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
cox_df <- readRDS("Data/coad_df_finished.rds")
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[11]) {
    ...
    mirna_mad_optimized <- two_weight_optimizer(
      ...
      my.filename = paste0("Data/Optimization_", c, "_targets_cc_singlecell_mm_", a, "_alpha_", data_set, ".rds")
    )
    ...
    for (mm in mirna_mad_optimized[10]) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.n = FALSE,
          tumor.m = FALSE,
          my.filename = paste0("Data/cc_singlecell_mm_ideal_gene_size_coefs.csv")
        )
    ...
    write.csv(top_cindices, file = paste0("Data/cc_singlecell_mm_coad_df_ideal_gene_size.csv"))
    write.csv(my_cindices, file = paste0("Data/cc_singlecell_mm_coad_df_all_gene_size_data.csv"))
  }
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used) {
    ...
    for (mm in mirna_mad_optimized) {
      cox_model <- cox_model_fitter(
        ...
        tumor.n = FALSE,
        tumor.m = FALSE,
        my.filename = paste0("Data/cc_singlecell_mm_ideal_mirna_combo_coefs.csv")
      )
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_mm_coad_df_ideal_mirna_combo.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_mm_coad_df_all_mirna_combo_performance_data.csv"))
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[19]) {
    ...
    for (mms in mirna_mad_sde_optimized) {
      cox_model <- cox_model_fitter(
        ...
        tumor.n = FALSE,
        tumor.m = FALSE,
        my.filename = paste0("Data/cc_singlecell_mms_ideal_mirna_combo_coefs.csv")
      )
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_mms_coad_df_ideal_mirna_combo.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_mms_coad_df_all_mirna_combo_performance_data.csv"))
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[11]) {
    ...
    for (mms in mirna_mad_sde_optimized) {
      cox_model <- cox_model_fitter(
        ...
        tumor.n = FALSE,
        tumor.m = FALSE,
        my.filename = paste0("Data/cc_singlecell_mms_ideal_mirna_combo_coefs_ms.csv")
      )
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_mms_coad_df_ideal_mirna_combo_ms_combo_used.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_mms_coad_df_all_mirna_combo_performance_data_ms_combo_used.csv"))
}
```
...
fig2c_plot <- risk_score_calculator(
  my.file = "Data/cc_singlecell_mms_ideal_mirna_fig_s3_coefs.csv",
...
coad_coef_df <- read.csv("Data/cc_singlecell_mms_ideal_mirna_fig_s3_coefs.csv")
...
cox_df <- readRDS("Data/read_df_finished.rds")
```
...
read_mirnas <- mirna_calculator(
  save.mirna.genes = TRUE,
  mirna.ranking.name = "Data/high_mirna_read.rds",
  mirna.remove = c("hsa-miR-129-2-3p", "hsa-miR-129-1-3p"),
  mirna.genes.mat.name = "Data/mirna_high_matrix_read.rds",
  save.mirna.genes.mat = TRUE
)
```
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/mad_read_coefs_", gs, "_genes.csv")
  )
...
write.csv(mad_cindices_read_df,
  file = "Data/mad_cindices_read_across_gene_size.csv"
)
```
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/sde_read_coefs_", gs, "_genes.csv")
  )
...
write.csv(sde_cindices_read_df,
  file = "Data/sde_cindices_read_across_gene_size.csv"
)
```
...
# Loading the high miRNA-miRNA target file
load("Data/mirna_heatmap_inputs/READ/800_1010_targets.RData",
  verbose = TRUE
)
load("Data/mirna_heatmap_inputs/READ/1000_110_targets.RData", verbose = TRUE)
load("Data/mirna_heatmap_inputs/READ/1000_1010_targets.RData", verbose = TRUE)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/high_mirna_read_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_high_cindices_read_across_gene_size.csv"
)
```
...
# Medium miRNA-miRNA target number
# Loading the medium miRNA-miRNA target file
load("Data/mirna_heatmap_inputs/READ/400_510_targets.RData",
  verbose = TRUE
)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/medium_mirna_read_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_medium_cindices_read_across_gene_size.csv"
)
```
...
# low miRNA-miRNA target number
# Loading the low miRNA-miRNA target file
load("Data/mirna_heatmap_inputs/READ/100_10_targets.RData", verbose = TRUE)
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/low_mirna_read_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  ...
  "Data/mirna_low_cindices_read_across_gene_size.csv"
)
```
...
# Saving the finished graph in .svg format
ggsave(
  filename = "Data/mirna_mirna_target_num_across_gene_size_read.svg",
...
random_read1 <- read.csv(random_read1, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes1.csv")
random_read2 <- read.csv(random_read2, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes2.csv")
random_read3 <- read.csv(random_read3, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes3.csv")
random_read4 <- read.csv(random_read4, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes4.csv")
random_read5 <- read.csv(random_read5, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes5.csv")
random_read6 <- read.csv(random_read6, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes6.csv")
random_read7 <- read.csv(random_read7, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes7.csv")
random_read8 <- read.csv(random_read8, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes8.csv")
random_read9 <- read.csv(random_read9, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes9.csv")
random_read10 <- read.csv(random_read10, "Data/Reproducible-results/Rmarkdown/Outputs/random_read_genes10.csv")
...
for (rg in all_random_gene_cindices) {
  ...
  cox_model <- cox_model_fitter(
    ...
    tumor.n = FALSE,
    tumor.m = FALSE,
    my.filename = paste0("Data/random_read_coefs_for_random_genes.csv")
  )
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[11]) {
    ...
    mad_sde_optimized <- two_weight_optimizer(
      first.metric = mad.genes,
      second.metric = sde.genes,
      my.filename = paste0("Data/Optimizations/Optimization_", c, "_targets_mad_sde", data_set, ".rds")
    )
    ...
    for (md in mad_sde_optimized[1:11]) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.n = FALSE,
          tumor.m = FALSE,
          my.filename = paste0("Data/mad_sde_read_coefs.csv")
        )
    ...
    write.csv(my_cindices, file = paste0("Data/mad_sde_read_df.csv"))
  }
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[2]) {
    my_cindices <- rep(0, 11)
    counter <- 1
    load(file = paste0("Data/mirna_heatmap_inputs/READ/", c, "_targets.RData"), verbose = TRUE)
    mirna.genes <- mirna.ranking
    mirna_mad_optimized <- two_weight_optimizer(
      first.metric = mirna.genes,
      second.metric = mad.genes,
    ...
    write.csv(top_cindices, file = paste0("Data/cc_singlecell_mm_read_df_ideal_gene_size.csv"))
    write.csv(my_cindices, file = paste0("Data/cc_singlecell_mm_read_df_all_gene_size_data.csv"))
  }
}
```
...
for (a in alpha_value[3]) {
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_mm_read_df_ideal_mirna_combo.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_mm_read_df_all_mirna_combo_performance_data.csv"))
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[2]) {
    ...
    write.csv(top_cindices, file = paste0("Data/cc_singlecell_ms_read_df_ideal_gene_size.csv"))
    write.csv(my_cindices, file = paste0("Data/cc_singlecell_ms_read_df_all_gene_size_data.csv"))
  }
}
```
...
for (a in alpha_value[3]) {
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_ms_read_df_ideal_mirna_combo.csv"))
  write.csv(my_cindices, file = paste0("Data/cc_singlecell_ms_read_df_all_mirna_combo_performance_data.csv"))
}
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used) {
    ...
    mirna_mad_sde_optimized <- three_weight_optimizer(
      ...
      second.metric = mad.genes,
      third.metric = sde.genes,
      my.filename = paste0("Data/Optimization_", c, "_targets_cc_singlecell_mms_", a, "_alpha_", data_set, ".rds")
    )
    ...
    for (mms in mirna_mad_sde_optimized[1:121]) {
      cox_model <- cox_model_fitter(
        ...
        tumor.n = FALSE,
        tumor.m = FALSE,
        my.filename = paste0("Data/cc_singlecell_mms_", data_set, "_coefs_genes_", mms, "_index.csv")
      )
  ...
  write.csv(top_cindices, file = paste0("Data/cc_singlecell_mms_read_top_cindex.csv"))
}
```
...
write.csv(methods_optimal_gene_read_df,
  file = "Data/methods_read_cindex.csv"
)
```
...
fig2d_plot <- risk_score_calculator(
  my.file = "Data/cc_singlecell_mms_read_coefs_at_top_combo_and_index.csv",
  tumor.data = FALSE, n.data = FALSE,
  set.ci = TRUE,
  cox.df = cox_df,
...
all_tumor_cells_fpkm <- read.csv("Data/GSE81861_CRC_tumor_all_cells_FPKM.csv")
...
all_nm_cells_fpkm <- read.csv("Data/GSE81861_CRC_NM_all_cells_FPKM.csv")
...
saveRDS(all_tumor_cells_fpkm,
  file = "Data/all_tumor_cells_fpkm.rds"
)
saveRDS(all_nm_cells_fpkm,
  file = "Data/all_nm_cells_fpkm.rds"
)
```
...
ggsave(
  filename = "Data/single_cell_library_histogram_pre_process_step_1_fpkm_df.svg",
...
ggsave(
  filename = "Data/single_cell_library_histogram_pre_process_step_2_fpkm_df.svg",
...
saveRDS(fpkm_df$denoised_sc_dataframe,
  file = "Data/denoised-colon-and-rectal-single-cell-data_fpkm_df.rds"
)
```
...
all_tumor_cells_counts <- read.csv("Data/GSE81861_CRC_tumor_all_cells_COUNT.csv")
...
all_nm_cells_counts <- read.csv("Data/GSE81861_CRC_NM_all_cells_COUNT.csv")
...
saveRDS(all_tumor_cells_counts,
  file = "Data/all_tumor_cells_counts.rds"
)
saveRDS(all_nm_cells_counts,
  file = "Data/all_nm_cells_counts.rds"
)
...
ggsave(
  filename = "Data/single_cell_library_histogram_pre_process_step_1_counts_df.svg",
  device = "svg", units = "mm", dpi = 600, width = 24, height = 24,
  plot = library_size_plot_1
)
...
ggsave(
  filename = "Data/single_cell_library_histogram_pre_process_step_2_counts_df.svg",
  device = "svg", units = "mm", dpi = 600, width = 20, height = 20,
  plot = library_size_plot_2
)
...
saveRDS(counts_df$denoised_sc_dataframe,
  file = "Data/denoised-colon-and-rectal-single-cell-data_counts_df.rds"
)
```
...
gene_sizes <- seq(100, 3000, 50)
scdd_res <- readRDS("Data/scdd_res_read.rds")
cox_df <- readRDS("Data/coad_df_finished.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    my.dataset = "COAD",
    my.filename = "Data/scdd_coefs_coad.csv"
  )
...
write.csv(max(my_cindices), file = "Data/coad_scdd_top_cindex.csv")
saveRDS(my_cindices, file = "Data/coad_scdd_top_cindex.rds")
```

## Step 35: DEsingle for COAD
```{r DEsingle on COAD}
# For finding the optimal number of genes
des_results <- readRDS(file = "Data/des_results_read.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    my.dataset = "COAD",
    my.filename = "Data/desingle_coefs_coad.csv"
  )
...
write.csv(max(my_cindices), file = "Data/coad_desingle_top_cindex.csv")
saveRDS(my_cindices, file = "Data/coad_desingle_top_cindex.rds")
```

## Step 36: DESeq2 for COAD
```{r deseq2 on COAD}
deseq2_genes <- readRDS(file = "Data/deseq2_top_genes.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    my.dataset = "READ",
    my.filename = "Data/deseq2_coefs_coad.csv"
  )
...
write.csv(max(my_cindices), file = "Data/coad_deseq2_top_cindex.csv")
saveRDS(my_cindices, file = "Data/coad_deseq2_top_cindex.rds")
```

## Step 37: edgeR for COAD
```{r edgeR on COAD}
edger_genes <- readRDS(file = "Data/edgeR_1927_genes.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    my.dataset = "READ",
    my.filename = "Data/edger_coefs_coad.csv"
  )
...
write.csv(max(my_cindices), file = "Data/coad_edger_top_cindex.csv")
saveRDS(my_cindices, file = "Data/coad_edger_top_cindex.rds")
```
...
edger_coad_max <- readRDS(file = "Data/coad_edger_top_cindex.rds")
deseq2_coad_max <- readRDS("Data/coad_deseq2_top_cindex.rds")
scdd_coad_max <- readRDS("Data/coad_scdd_top_cindex.rds")
des_coad_max <- readRDS("Data/coad_desingle_top_cindex.rds")
...
```{r saving fig3a data}
saveRDS(coad_other_methods_df, file = "Data/cc_singlecell_vs_other_methods_df_coad.rds")
write.csv(coad_other_methods_df, file = "Data/cc_singlecell_vs_other_methods_df_coad.csv")
```
...
saveRDS(scdd_res, file = "Data/scdd_res_read.rds")
write.csv(scdd_res, file = "Data/scdd_res_read.csv")
```
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = scdd_res$gene[1:gs],
    my.dataset = "READ",
    my.filename = "Data/scdd_coefs.csv"
  )
...
write.csv(max(my_cindices), file = "Data/read_scdd_top_cindex.csv")
saveRDS(my_cindices, file = "Data/read_scdd_top_cindex.rds")
```
...
saveRDS(deseq2_genes, file = "Data/deseq2_top_genes.rds")
write.csv(deseq2_genes, file = "Data/deseq2_top_genes.csv")
```
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = deseq2_genes[1:gs],
    my.dataset = "READ",
    my.filename = "Data/deseq2_coefs.csv"
  )
...
write.csv(max(my_cindices), file = "Data/read_deseq2_top_cindex.csv")
saveRDS(my_cindices, file = "Data/read_deseq2_top_cindex.rds")
```
...
write.csv(finished_edger, file = "Data/edgeR_1927_genes.csv")
saveRDS(finished_edger, file = "Data/edgeR_1927_genes.rds")
```
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    my.dataset = "READ",
    my.filename = "Data/edger_coefs.csv"
  )
...
write.csv(max(my_cindices), file = "Data/read_edger_top_cindex.csv")
saveRDS(my_cindices, file = "Data/read_edger_top_cindex.rds")
```
...
saveRDS(des_results, file = "Data/des_results_read.rds")
write.csv(des_results, file = "Data/des_results_read.csv")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = rownames(des_results)[1:gs],
    my.dataset = "READ",
    my.filename = "Data/desingle_coefs.csv"
  )
...
write.csv(max(my_cindices), file = "Data/read_desingle_top_cindex.csv")
saveRDS(my_cindices, file = "Data/read_desingle_top_cindex.rds")
```


```{r deseq2 filtering}
all_tumor_cells_fpkm <- read.csv("Data/GSE81861_CRC_tumor_all_cells_COUNT.csv")
rownames(all_tumor_cells_fpkm) <- all_tumor_cells_fpkm$X
all_tumor_cells_fpkm <- gene_name_cleaner(data.to.clean = all_tumor_cells_fpkm)
all_tumor_cells_fpkm <- t(all_tumor_cells_fpkm)
...
all_nm_cells_fpkm <- read.csv("Data/GSE81861_CRC_NM_all_cells_COUNT.csv")
rownames(all_nm_cells_fpkm) <- all_nm_cells_fpkm$X
all_nm_cells_fpkm <- gene_name_cleaner(data.to.clean = all_nm_cells_fpkm)
all_nm_cells_fpkm <- t(all_nm_cells_fpkm)
my_tumor_row_names <- rownames(all_nm_cells_fpkm)
...
ggsave(
  filename = "Data/single_cell_library_histogram_pre_process_step_1_deseq2_df.svg",
  device = "svg", units = "mm", dpi = 600, width = 24, height = 24,
  plot = library_size_plot_1
)
```
...
```{r fig3b data}
# ggplot2 bar chart for the comparison of different methods to our method
edger_read_max <- readRDS(file = "Data/read_edger_top_cindex.rds")
deseq2_read_max <- readRDS("Data/read_deseq2_top_cindex.rds")
scdd_read_max <- readRDS("Data/read_scdd_top_cindex.rds")
des_read_max <- readRDS("Data/des_results_read.rds")
...
```{r saving fig3b data}
saveRDS(read_other_methods_df, file = "Data/cc_singlecell_vs_other_methods_df_read.rds")
write.csv(read_other_methods_df, file = "Data/cc_singlecell_vs_other_methods_df_read.csv")
```
...
```{r fig4b}
read_coef_df <- read.csv("Data/cc_singlecell_mms_read_coefs_at_top_combo_and_index.csv")
...
figs1a <- readRDS("Data/figs1a_smaller_matrix.rds")

# figs1a <- readRDS("Data/figs1_mirna_score_matrix.rds")


svg(filename = "Data/figs1a.svg", width = 8, height = 8)
...
```{r figs1b}
figs1b <- readRDS("Data/figs1_mirnas.rds")
...
figs2a_df <- read.csv("Data/cc_singlecell_mms_coad_top_cindex.csv")
...
figs2b_df_done <- read.csv("Data/read_grid_search_data.csv")
...
```{r figs5 coad}
# COAD
cox_df <- readRDS(file = "Data/coad_df_finished.rds")
...
```{r saving figs5 coad}
ggsave(
  filename = "Data/figs5a_increase.svg",
...
```{r figs5 read}
# READ
cox_df <- readRDS(file = "Data/read_df_finished.rds")
...
```{r saving figs5 read}
ggsave(
  filename = "Data/figs5b_increase.svg",
...
```{r}
ggsave(
  filename = "Data/figs5a_decrease.svg",
...
```{r saving figs5 read}
ggsave(
  filename = "Data/figs5b_decrease.svg",
...
patient_meta <- read.csv("Data/data_clinical_patient.txt", sep = "\t")
...
patient_rna <- read.csv("Data/data_mrna_seq_expression.txt", sep = "\t")
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.m = FALSE,
    n.folds = 10,
    my.filename = paste0("Data/mad_non_tcga_crc_coefs_", gs, "_genes.csv")
  )
...
colnames(mad_cindices_read_df)[2] <- "c_index"
write.csv(mad_cindices_read_df,
  file = "Data/mad_cindices_non_tcga_crc_across_gene_size.csv"
)
```
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.m = FALSE,
    n.folds = 10,
    my.filename = paste0("Data/sde_non_tcga_coefs_", gs, "_genes.csv")
  )
...
colnames(sde_cindices_read_df)[2] <- "c_index"
write.csv(sde_cindices_read_df,
  file = "Data/sde_cindices_non_tcga_across_gene_size.csv"
)
```
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[11]) {
    ...
    mad_sde_optimized <- two_weight_optimizer(
      first.metric = mad.genes,
      second.metric = sde.genes,
      my.filename = paste0("Data/", c, "_targets_mad_sde", data_set, ".rds")
    )
    ...
    for (md in mad_sde_optimized[1:11]) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.m = FALSE,
          n.folds = 10,
          my.filename = paste0("Data/mad_sde_non_tcga_coefs.csv")
        )
    ...
    write.csv(my_cindices, file = paste0("Data/mad_sde_non_tcga_df.csv"))
  }
}
```
...
for (gs in gene_sizes) {
  cox_model <- cox_model_fitter(
    ...
    tumor.m = FALSE,
    n.folds = 10,
    my.filename = paste0("Data/high_mirna_non_tcga_coefs_", gs, "_genes.csv")
  )
...
write.csv(
  mirna_high_cindices_read_df,
  "Data/mirna_high_cindices_non_tcga_across_gene_size.csv"
)
```
...
non_tcga_cox <- readRDS("Data/non_tcga_cox.rds")
...
random_non_tcga1 <- read.csv(random_non_tcga1, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes1.csv")
random_non_tcga2 <- read.csv(random_non_tcga2, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes2.csv")
random_non_tcga3 <- read.csv(random_non_tcga3, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes3.csv")
random_non_tcga4 <- read.csv(random_non_tcga4, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes4.csv")
random_non_tcga5 <- read.csv(random_non_tcga5, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes5.csv")
random_non_tcga6 <- read.csv(random_non_tcga6, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes6.csv")
random_non_tcga7 <- read.csv(random_non_tcga7, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes7.csv")
random_non_tcga8 <- read.csv(random_non_tcga8, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes8.csv")
random_non_tcga9 <- read.csv(random_non_tcga9, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes9.csv")
random_non_tcga10 <- read.csv(random_non_tcga10, "Data/Reproducible-results/Rmarkdown/Outputs/random_non_tcga_genes10.csv")
...
for (rg in all_random_gene_cindices) {
  ...
  cox_model <- cox_model_fitter(
    ...
    tumor.m = FALSE,
    n.folds = 10,
    my.filename = paste0("Data/random_non_tcga_coefs_for_random_genes.csv")
  )
...
write.csv(
  all_random_gene_cindices,
  "Data/non_tcga_crc_random_genes.csv"
)
...
sde_genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
non_tcga_cox <- readRDS("Data/non_tcga_cox.rds")
...
for (gs in gene_sizes) {
  ...
  for (c in combo_used) {
    ...
    optimized <- two_weight_optimizer(
      ...
      my.filename = paste0("Data/Optimization_ccs_ms_non_tcga_", c, ".rds")
    )
    ...
    for (ms in optimized[1:11]) {
      ...
      cox_model <- cox_model_fitter(
        ...
        tumor.m = FALSE,
        n.folds = 10,
        my.filename = paste0("Data/non_tcga_crc.csv")
      )
...
write.csv(cc_single_mms_df,
  file = "Data/cc_singlecell_ms_test.csv"
)
...
for (a in alpha_value[3]) {
  ...
  for (c in combo_used[1:110]) {
    ...
    for (ms in mirna_sde_optimized[1:11]) {
      for (gs in gene_sizes) {
        cox_model <- cox_model_fitter(
          ...
          tumor.m = FALSE,
          n.folds = 10,
          my.filename = paste0("Data/cc_singlecell_mm_ideal_gene_size_coefs_non_tcga_crc.csv")
        )
    ...
    write.csv(top_cindices, file = paste0("Data/cc_singlecell_mm_non_tcga_crc_df_ideal_gene_size.csv"))
    write.csv(my_cindices, file = paste0("Data/cc_singlecell_mm_non_tcga_crc_df_all_gene_size_data.csv"))
  }
}
```
...
sde_genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
mad_genes <- readRDS("Data/mad_colon_and_rectal_cancer.rds")
non_tcga_cox <- readRDS("Data/non_tcga_cox.rds")
all_combos_best <- rep(0, length(combo_used))
...
print("Renaming columns")
write.csv(cc_single_mms_df,
  file = "Data/cc_singlecell_mms_test.csv"
)
print("Saving finished csv file")
```
...
des_results <- readRDS("Data/des_results_read.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = rownames(des_results)[1:gs],
    n.folds = 10,
    my.filename = "Data/desingle_non_tcga_coefs.csv"
  )
...
scdd_res <- readRDS("Data/scdd_res.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = scdd_res$gene[1:gs],
    n.folds = 10,
    my.filename = "Data/scdd_non_tcga_coefs.csv"
  )
...
finished_edger <- readRDS("Data/edgeR_1927_genes.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    cox.predictors = rownames(finished_edger)[1:gs],
    n.folds = 10,
    my.filename = "Data/edger_coefs_non_tcga.csv"
  )
...
finished_deseq <- readRDS("Data/deseq2_top_genes.rds")
...
for (gs in gene_sizes) {
  current_cox <- cox_model_fitter(
    ...
    n.folds = 10,
    my.filename = "Data/deseq2_coefs_non_tcga.csv"
  )
...
coad_ms_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_ms_coad_used_combo_100_1010_index_5_df.csv")
...
coad_ms_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_ms_coad_used_combo_100_1010_index_5_df.csv")
...
coad_ms_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_ms_coad_used_combo_100_1010_index_5_df.csv")
...
ggsave(
  filename = "Data/cc_singlecell_ms_coad_grid_search_heatmap_alpha_0_figs2.svg",
...
ggsave(
  filename = "Data/cc_singlecell_ms_coad_grid_search_heatmap_alpha_05_figs2.svg",
  plot = print(heatmap_coad_ccs_ms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_ms_coad_grid_search_heatmap_alpha_1_figs2.svg",
  plot = print(heatmap_coad_ccs_ms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
read_ms_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_ms_read_used_combo_100_1010_index_8_df.csv")
...
read_ms_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_ms_read_used_combo_100_1010_index_8_df.csv")
...
read_ms_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_ms_read_used_combo_100_1010_index_11_df.csv")
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_ms_read_grid_search_heatmap_alpha_0.svg",
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_ms_read_grid_search_heatmap_alpha_05.svg",
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_ms_read_grid_search_heatmap_alpha_1.svg",
...
coad_mm_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_mm_coad_used_combo_100_1010_index_5_df.csv")
...
coad_mm_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_mm_coad_used_combo_100_1010_index_10_df.csv")
...
coad_mm_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_mm_coad_used_combo_100_1010_index_10_df.csv")
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_coad_grid_search_heatmap_alpha_0.svg",
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_coad_grid_search_heatmap_alpha_05.svg",
  plot = print(heatmap_coad_ccs_mm_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_coad_grid_search_heatmap_alpha_1.svg",
  plot = print(heatmap_coad_ccs_mm_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 34, height = 34,
  units = "mm"
...
read_mm_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_mm_read_used_combo_100_1010_index_1_df.csv")
...
read_mm_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_mm_read_used_combo_100_1010_index_7_df.csv")
...
read_mm_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_mm_read_used_combo_100_1010_index_10_df.csv")
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_read_grid_search_heatmap_alpha_0.svg",
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_read_grid_search_heatmap_alpha_05.svg",
  plot = print(heatmap_read_ccs_mm_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mm_read_grid_search_heatmap_alpha_1.svg",
  plot = print(heatmap_read_ccs_mm_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
coad_mms_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_mms_coad_used_combo_100_1010_index_86_df.csv")
...
coad_mms_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_mms_coad_used_combo_100_1010_index_17_df.csv")
...
coad_mms_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_mms_coad_used_combo_100_1010_index_17_df.csv")
...
ggsave(
  filename = "Data/cc_singlecell_mms_coad_grid_search_heatmap_alpha_0_figs2.svg",
...
ggsave(
  filename = "Data/cc_singlecell_mms_coad_grid_search_heatmap_alpha_05_figs2.svg",
  plot = print(heatmap_coad_ccs_mms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 290, height = 290,
  units = "mm"
...
ggsave(
  filename = "Data/cc_singlecell_mms_coad_grid_search_heatmap_alpha_1_figs2.svg",
  plot = print(heatmap_coad_ccs_mms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
...
read_mms_0 <- read.csv("Data/top_cindices_alpha_0_cc_singlecell_mms_read_used_combo_900_1010_index_56_df.csv")
...
read_mms_05 <- read.csv("Data/top_cindices_alpha_0.5_cc_singlecell_mms_read_used_combo_100_1010_index_7_df.csv")
...
read_mms_1 <- read.csv("Data/top_cindices_alpha_1_cc_singlecell_mms_read_used_combo_100_1010_index_10_df.csv")
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mms_read_grid_search_heatmap_alpha_0.svg",
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mms_read_grid_search_heatmap_alpha_05.svg",
  plot = print(heatmap_read_ccs_mms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
# Now saving the heat map
ggsave(
  filename = "Data/cc_singlecell_mms_read_grid_search_heatmap_alpha_1.svg",
  plot = print(heatmap_read_ccs_mms_finished, newpage = FALSE),
  device = "svg", dpi = 600,
  width = 32, height = 32,
  units = "mm"
...
mad_genes <- readRDS("Data/mad_colon_and_rectal_cancer.rds")
sde_genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
load(file = "Data/mirna_heatmap_inputs/COAD/700_810_targets.RData", verbose = TRUE)
mirna_genes <- mirna.ranking
...
mad_genes <- readRDS("Data/mad_colon_and_rectal_cancer.rds")
sde_genes <- readRDS("Data/sde_colon_and_rectal_cancer.rds")
load(file = "Data/mirna_heatmap_inputs/READ/300_310_targets.RData", verbose = TRUE)
mirna_genes <- mirna.ranking
...
for (p in 1:length(my_plots)) {
  ggsave(
    filename = paste0("Data/", p, "_distribution.png"),
...
# level
tian_emt_genes <- read.csv("Data/emt_genes_tian.csv")
...
for (g in random_genes_e$Gene[1:nrow(random_genes_e)]) {
  cds_output <- cell_dataset_builder(
    ...
    my.root = "Y_4",
    norm.flag = "log",
    my.cds.filename = paste0("Data/cds_ouput_all_tian_e_genes_", g, ".rds"),
    my.monocle.graph = paste0("Data/vim_pseudotime_all_tian_e_genes_", g, ".svg"),
    my.monocle.graph.genes = paste0("Data/vim_genes_all_tian_e_genes_", g, ".svg"),
    my.pt.data.filename = paste0("Data/vim_pseudotime_data_all_tian_e_genes_", g, ".csv")
  )
}
...
for (g in random_genes_m$Gene[1:nrow(random_genes_m)]) {
  cds_output <- cell_dataset_builder(
    ...
    my.monocle.plot.dpi = 600,
    norm.flag = "log",
    my.cds.filename = paste0("Data/cds_ouput_all_tian_m_genes_", g, ".rds"),
    my.monocle.graph = paste0("Data/vim_pseudotime_all_tian_m_genes_", g, ".svg"),
    my.monocle.graph.genes = paste0("Data/vim_genes_all_tian_m_genes_", g, ".svg"),
    my.pt.data.filename = paste0("Data/vim_pseudotime_data_all_tian_m_genes_", g, ".csv")
  )
}
```
...
my_sc_df <- readRDS("Data/denoised-colon-and-rectal-single-cell-data.rds")
my_sc_df_names <- readRDS("Data/denoised-colon-and-rectal-single-cell-data-gene-names.rds")
random_genes_e <- read.csv("Data/tian_emt_genes_e_set_randomly_selected.csv")
cds_output <- cell_dataset_builder(
  ...
  my.cds.filename = "Data/cds_ouput.rds",
  my.monocle.graph = "Data/vim_pseudotime.svg",
  my.monocle.graph.genes = "Data/30_e_genes_expression_profile_updated_600_dpi.svg",
  my.pt.data.filename = "Data/vim_pseudotime_data.csv"
)
cds_output$`Cell Progression Graph`
```
...
random_genes_m <- read.csv("Data/tian_emt_genes_m_set_randomly_selected.csv")
cds_output <- cell_dataset_builder(
  ...
  my.cds.filename = "Data/cds_ouput.rds",
  my.monocle.graph = "Data/vim_pseudotime.svg",
  # my.monocle.graph.genes = "Data/hallmark_emt_genes_expression_profile_updated_600_dpi.svg",
  my.monocle.graph.genes = "Data/30_m_emt_genes_expression_profile_updated_600_dpi.svg",
  my.pt.data.filename = "Data/vim_pseudotime_data.csv"
)
cds_output$`Cell Progression Graph`
```
...
do_corr_analysis <- function(cds_output, save_mat = TRUE) {
  ...
  M
  if (save_mat == TRUE) {
    write.csv(x = M, file = paste0("Data/m-gene-corr-matricies/", g, ".csv"))
  }
  return(M)
}
```
...
for (g in tian_emt_genes_e$Gene) {
  cds_output <- cell_dataset_builder(
    ...
    use.function = FALSE,
    norm.flag = "log",
    my.cds.filename = "Data/cds_ouputput_e_genes_only_with_vim_root.rds",
    my.monocle.graph = "Data/vim_pseudotime_e_genes_only_with_vim_root.svg",
    my.monocle.graph.genes = "Data/vim_genes_e_genes_only_with_vim_root.svg",
    my.pt.data.filename = "Data/vim_pseudotime_data_e_genes_only_with_vim_root.csv"
  )
...
e_files <- list.files(path = "Data/e-genes-corr-matricies/")
all_cors <- c(rep(0, length(tian_emt_genes_e$Gene)))
counter <- 1
for (f in e_files) {
  current_file <- read.csv(paste0("Data/e-genes-corr-matricies/", f))
...
ggsave(
  filename = "Data/e_correlation_histogram.svg",
...
for (g in tian_emt_genes_m$Gene) {
  cds_output <- cell_dataset_builder(
    ...
    use.function = FALSE,
    norm.flag = "log",
    my.cds.filename = "Data/cds_ouputput_m_genes_only_with_vim_root.rds",
    my.monocle.graph = "Data/vim_pseudotime_m_genes_only_with_vim_root.svg",
    my.monocle.graph.genes = "Data/vim_genes_m_genes_only_with_vim_root.svg",
    my.pt.data.filename = "Data/vim_pseudotime_data_m_genes_only_with_vim_root.csv"
  )
  do_corr_analysis(cds_output = cds_output, save_mat = TRUE)
}
```
...
m_files <- list.files(path = "Data/m-gene-corr-matricies/")
all_cors <- c(rep(0, length(tian_emt_genes_m$Gene)))
counter <- 1
for (f in m_files) {
  current_file <- read.csv(paste0("Data/m-gene-corr-matricies/", f))
  current_corr <- current_file$Expr[2]
  all_cors[counter] <- current_corr
  counter <- counter + 1
}
...
ggsave(
  filename = "Data/m_correlation_histogram.svg",
