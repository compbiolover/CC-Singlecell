...
fig2c_plot <- risk_score_calculator(my.file = "~/Desktop/cc_singlecell_ms_read_alpha_1_coefs_index_6.csv",
...
coad_coef_df <- read.csv("~/Desktop/cc_singlecell_ms_coad_alpha_1_coefs_index_6.csv")
...
coad_coef_df_sub <- filter(coad_coef_df_sub, Gene != "TRIM60")
coad_coef_df_sub <- filter(coad_coef_df_sub, Gene != "GRAMD4P2")
coad_coef_df_sub <- filter(coad_coef_df_sub, Gene != "ENPP7P6")
...
ggsave(filename = "Data/Reproducible-results/Figures/cc_singlecell_mms_coad_coef_plot.svg",
