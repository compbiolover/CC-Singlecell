...
# top_cindices <- c()
 ...
 for(a in alpha_value){
   ...
   write.csv(top_cindices, file = paste0("top_cindices_alpha_",a,"_cc_singlecell_mm_read_used_combo_",c,"_index_",top_index_used,"_df.csv"))
...
for(a in alpha_value){
  ...
  write.csv(top_cindices, file = paste0("top_cindices_alpha_",a,"_cc_singlecell_mms_read_used_combo_",c,"_index_",top_index_used,"_df.csv"))
