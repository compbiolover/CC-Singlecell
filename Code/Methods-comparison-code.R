...
#Subset data for error report on Github
all_nm_cells_fpkm_subset <- all_nm_cells_fpkm[1:50,1:5]
#save(all_nm_cells_fpkm_subset, file = "Data/Exported-data/Csv-files/Error-outputs/all_nm_cells_fpkm_subset.RData")

all_tumor_cells_fpkm_subset <- all_tumor_cells_fpkm[1:50,1:5]
#save(all_tumor_cells_fpkm_subset, file = "Data/Exported-data/Csv-files/Error-outputs/all_tumor_cells_fpkm_subset.RData")
