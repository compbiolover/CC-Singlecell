#Name: desingle_optimal_gene.R
#Author: Andrew Willems <awillems@vols.utk.edu>
#Purpose: To find the ideal number of genes for the DEsingle method for datasets
...
cindices <- list()
gene_sizes <- list()
for(gene_num in desingle_gene_nums){
  current_num <- read.csv(paste0("Data/Data-from-Cleaner-code/desingle_top_",gene_num,"_genes_cc_patients.csv"))
  cox_model <- cox_model_fitter(my.seed = 1,
                                ...
                                my.filename = paste0("Data/TCGA-COAD/Data/Other-methods/desingle/Outputs/desingle_",gene_num, "genes.csv"))
...
write.csv(cindices_df, file = "Data/Other-methods/desingle/Outputs/cindices_df_desingle_rc.csv")
