...
#Purpose: To exploit the power of the lab servers for COAD dataset
...
#   mirna_sde_optimized <- two_weight_optimizer(first.metric = mirna.genes,
#                                               second.metric = mad.genes,
#                                               my.filename = paste0("Optimization_",c,"_targets_cc_singlecell_mm_",data_set,".rds"))
#   
#   
#   
#   
...
#                                   tumor.n = FALSE,
#                                   tumor.m = FALSE,
#                                   my.filename = paste0("cc_singlecell_mm_",data_set,"_coefs_",gs,"_genes_",mm,"_index.csv"))
#     
#     #Getting the top concordance index from the cross validation and then rounding
#     #it to 4 digits to follow cv.glmnet reporting convention. Finally, we update
#     #the c_index list with the result
...
write.csv(top_cindices, file = paste0("top_cindices_cc_singlecell_mms_used_combo_",c,"_index_",top_index_used,"_df.csv"))
