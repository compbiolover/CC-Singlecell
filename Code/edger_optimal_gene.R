#Name: edger_optimal_gene.R
#Author: Andrew Willems <awillems@vols.utk.edu>
#Purpose: To find the ideal number of genes for the edgeR method for datasets
...
cindices <- list()
gene_sizes <- list()
for(gene_num in edger_gene_nums){
  current_num <- read.csv(paste0("Data/Data-from-Cleaner-code/edger_top_",gene_num,"_genes_cc_patients.csv"))
  cox_model <- cox_model_fitter(my.seed = 1,
                                ...
                                my.filename = paste0("Data/TCGA-COAD/Data/Other-methods/edger/Outputs/edger_",gene_num, "genes_rc.csv"))
...
write.csv(cindices_df, file = "Data/Other-methods/edger/Outputs/cindices_df_edger_rc.csv")
