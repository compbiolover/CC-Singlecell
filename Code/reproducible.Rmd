...
saveRDS(cc_tumor_fpkm,
        file = "Data/Reproducible-results/Rmarkdown/denoised-colon-and-rectal-single-cell-data.rds")
```
...
cds_output <- cell_dataset_builder(vim.genes = c("VIM", "VIMP"),
                                   ...
                                   my.root = "Y_19",
                                   my.cds.filename = "Data/Reproducible-results/Rmarkdown/cds_ouput.rds",
                                   my.monocle.graph = "Data/Reproducible-results/Rmarkdown/vim_pseudotime.svg",
                                   my.monocle.graph.genes = "Data/Reproducible-results/Rmarkdown/vim_genes.svg",
                                   my.pt.data.filename = "Data/Reproducible-results/Rmarkdown/vim_pseudotime_data.csv")
...
saveRDS(mad.genes,
        file = "Data/Reproducible-results/Rmarkdown/mad_colon_and_rectal_cancer.rds")
...
saveRDS(sde.genes,
        file = "Data/Reproducible-results/Rmarkdown/sde_colon_and_rectal_cancer.rds")

```

## Step Ten: Downloading the COAD bulk dataset from TCGA. We are using the FPKM dataset.
```{r}
...
saveRDS(cox_df, "~/Documents/PhD Program/Hong Lab/Projects/CC_Singlecell/Data/Reproducible-results/Rmarkdown/coad_df_finished.rds")

cox_df <- readRDS("~/Documents/PhD Program/Hong Lab/Projects/CC_Singlecell/Data/Reproducible-results/Rmarkdown/coad_df_finished.rds")
```
...
for(gs in gene_sizes){
  cox_model <- cox_model_fitter(my.seed = 1,
                                ...
                                tumor.n = FALSE,
                                tumor.m = FALSE,
                                my.filename = paste0("Data/Reproducible-results/Rmarkdown/mad_coad_coefs_",gs,"_genes.csv"))
...
write.csv(mad_cindices_coad_df,
          "Data/Reproducible-results/Rmarkdown/mad_cindices_coad_across_gene_size.csv")
...
write.csv(sde_cindices_coad_df,
          "Data/Reproducible-results/Rmarkdown/sde_cindices_coad_across_gene_size.csv")
```
