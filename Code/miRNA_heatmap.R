...
#                                   mirna.ranking.name = paste0("~/Documents/PhD Program/Hong Lab/Projects/CC_Singlecell/Data/TCGA-READ/Mirna/Global_Search/Inputs/RData/",mirna_num,"_",mt,"_targets_new_mirna_ranking.rds"))
# 
# }
# 
